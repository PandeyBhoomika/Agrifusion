...
const initialQuizCategories: QuizCategory[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: 'cm-q2',
        question: 'Monoculture farming increases pest resistance.',
        type: 'true-false',
        options: ['True', 'False'],
        correctAnswer: 1,
        explanation: 'False — monoculture actually increases pest vulnerability and reduces biodiversity.',
        points: 25,
        category: 'crop-management',
      },
      {
        id: 'cm-q3',
        question: 'When is the best time to plant rice in most regions?',
        type: 'multiple-choice',
        options: ['Winter', 'Summer', 'Monsoon season', 'Autumn'],
        correctAnswer: 2,
        explanation: 'Rice is typically planted during monsoon season when water is abundant.',
        points: 25,
        category: 'crop-management',
      },
    ],
    ...
    questions: [
      {
        ...
        correctAnswer: 2,
        explanation: 'Drip irrigation is the most water-efficient method, delivering water directly to plant roots.',
        points: 30,
        category: 'irrigation',
      },
      {
        id: 'ir-q2',
        question: 'Early morning is the best time to irrigate crops.',
        type: 'true-false',
        options: ['True', 'False'],
        correctAnswer: 0,
        explanation: 'True — early morning irrigation reduces water loss through evaporation.',
        points: 20,
        category: 'irrigation',
      },
      {
        id: 'ir-q3',
        question: 'What percentage of water should soil retain for optimal crop growth?',
        type: 'multiple-choice',
        options: ['10-20%', '30-50%', '60-80%', '90-100%'],
        correctAnswer: 1,
        explanation: 'Soil should retain 30-50% water for optimal crop growth and root development.',
        points: 25,
        category: 'irrigation',
      },
    ],
    ...
    questions: [
      {
        ...
        correctAnswer: 1,
        explanation: 'IPM combines biological, cultural, and chemical methods for sustainable pest control.',
        points: 30,
        category: 'pest-control',
      },
      {
        id: 'pc-q2',
        question: 'Neem oil is an effective organic pesticide.',
        type: 'true-false',
        options: ['True', 'False'],
        correctAnswer: 0,
        explanation: 'True — neem oil is a natural pesticide effective against many common pests.',
        points: 20,
        category: 'pest-control',
      },
      {
        id: 'pc-q3',
        question: 'Which of these is a beneficial insect for pest control?',
        type: 'multiple-choice',
        options: ['Aphid', 'Ladybug', 'Locust', 'Whitefly'],
        correctAnswer: 1,
        explanation: 'Ladybugs are beneficial insects that eat aphids and other harmful pests.',
        points: 25,
        category: 'pest-control',
      },
    ],
...
export default function Quiz() {
  ...
  const handleCategorySelect = useCallback(async (category: QuizCategory) => {
    setIsLoading(true);
    // Fetch fresh quiz data for the selected category
    const freshQuizData = await fetchQuizByCategory(category.id);
    if (freshQuizData) {
      setSelectedCategory(freshQuizData);
    } else {
      ...
      <SafeAreaView style={styles.safe}>
        ...
        <ScrollView contentContainerStyle={styles.content}>
          ...
          <TouchableOpacity style={styles.secondaryButton} onPress={() => router.back()}>
            <Text style={styles.secondaryButtonText}>Back to Learning Hub</Text>
          </TouchableOpacity>
        </ScrollView>
      </SafeAreaView>
      </LinearGradient>
    ...
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.introCard}>
          <Text style={styles.introTitle}>📝 Welcome to Quiz Center!</Text>
          <Text style={styles.introText}>
            Test your agricultural knowledge across different categories. Each quiz contains multiple questions
            to help you learn and improve your farming skills.
          </Text>
        </View>
