...
// Standard categories present in our schemes data
const CATEGORIES = [
  ...
  const handleApply = async (url: string) => {
    try {
      ...
      if (canOpen) {
        ...
        await Linking.openURL("https://keralaagriculture.gov.in");
      }
    } catch (error) {
      ...
      <SafeAreaView style={styles.safe}>
        ...
        <Animated.View entering={FadeInDown.duration(400)} style={styles.header}>
          ...
          <View style={styles.headerTextWrap}>
            ...
            <Text style={styles.headerSubtitle}>Find subsidies & agricultural support</Text>
          </View>
        </Animated.View>
        ...
        {loading ? (
          ...
          >
            ...
            <Text style={styles.emptySubtitle}>Try searching for another term or change the category.</Text>
          </ScrollView>
        ) : (
          <ScrollView
              ...
              return (
                ...
                >
                  <TouchableOpacity
                    ...
                    style={[
                      styles.schemeCard,
                      isExpanded && styles.schemeCardExpanded
                    ]}
                  >
                    {/* Top Row: Title & Arrow */}
                    ...
                    {/* Cost/Amount support info */}
                    <View style={styles.amountSection}>
                      <Text style={styles.amountLabel}>Support / Subsidy</Text>
